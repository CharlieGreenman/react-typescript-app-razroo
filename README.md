# Razroo React Typescript Mono Repo

This repo is a mono repo which uses the typescript-create-react-app fork.

The following are technologies included in this repo
- Redux
